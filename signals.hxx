...
namespace jlb
{
    ...
    private:
        SignalLibrary()
        {
            ...
            signals.at(POSITION_X_ID) = Signal({POSITION_X_ID, "position_x", "px", 0.0f, 1088.0f, 0.0f, 1000.0f});
            signals.at(POSITION_Y_ID) = Signal({POSITION_Y_ID, "position_y", "px", 0.0f, 1024.0f, 0.0f, 1000.0f});
